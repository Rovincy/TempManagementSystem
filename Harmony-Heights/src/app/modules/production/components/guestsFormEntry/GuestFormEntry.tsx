...
import {Api_Endpoint,fetchCompanies, fetchNationalities} from '../../../../services/ApiCalls'
...
const GuestMultiTabForm = () => {
  ...
  const {data: NationalityData, isLoading: fetchNationalitiesLoading} = useQuery('Nationality', fetchNationalities)
