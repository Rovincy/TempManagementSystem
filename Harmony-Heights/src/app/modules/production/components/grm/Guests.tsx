...
import {Api_Endpoint, addNoteApi, deleteGuestApi, fetchCompanies, fetchGuests, fetchNationalities} from '../../../../services/ApiCalls'
...
const Guests = () => {
  ...
  const {data: nationalityData, isLoading: nationalityLoad} = useQuery('nationality', fetchNationalities)
  ...
  // console.log("c: ",nationalityData?.data)
  var guestAndCompanies = getGuest?.data.map((e:any)=>{
  var comp =  getCompanies?.data.find((c:any)=>{
    // console.log("e: ",e)
    if (c.id===e.companyId) {
      // console.log("True")
      return {
  ...
  var nationality =  nationalityData?.data.find((d:any)=>{
    // console.log("d: ",d.id)
    // console.log("e: ",e.nationalityId)
    if (d.id===e.nationalityId) {
      // console.log("True")
      return d
      }
    })
