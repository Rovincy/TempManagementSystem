          ...
          {<div className='col-8'>
            ...
            <div className='row mb-0'>
              ...
              <div className='col-6 mb-7'>
                ...
                <Checkbox{...register("isActive")} defaultChecked={paymentMethodData.isActive==true?true:false}  className="form-control form-control-solid" onChange={(e) => setIsActive(e.target.checked)}/>
              </div>
            </div>
          </div>
          }
